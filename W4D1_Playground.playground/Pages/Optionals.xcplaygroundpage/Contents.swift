...
var person : String? = "David"
var dude : String = person!
...
numz.first
numz.last
if let first = numz.first, let last = numz.last {
...
if let mazdaprice = carPrices["Mazda3"] {
  print("\(mazdaprice)")
}
if let hondaPrice = carPrices["CRV"] {
  print("\(hondaPrice)")
}
if let hummerPrice = carPrices["Hummer"] {
  print("\(hummerPrice)")
}
if let hyundaiPrice = carPrices["Elantra"] {
  print("\(hyundaiPrice)")
}
